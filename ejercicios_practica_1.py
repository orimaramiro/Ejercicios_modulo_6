...
def ej2():
    ...
    stock_2 = {'tornillos': 0, 'tuercas': 0, 'arandelas': 0}

    # Paso 1:
    # Crear un bucle utilizando while que se ejecute de forma infinita
    # while True.....
    while True:
        print("Para salir ingrese la palabra fin")
        item = str(input('Ingrese un item a agrega al stock:'))
        
        if item == 'FIN':
            break
        elif item not in stock_2:
